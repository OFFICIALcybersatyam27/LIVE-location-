...
<img width="100%" align="centre" src="https://github.com/OFFICIALcybersatyam27/LIVE-location-/blob/main/R4ven_Thumbnail.png" />
...
```
git clone https://github.com/OFFICIALcybersatyam27/LIVE-location-.git
```
```
cd LIVE-location-
```
...
```
python3 Live-sry.py [-t target]
```
- To change Port
```
python3 Live-sry.py [-p port]
```
- For Both Image-URL and port
```
python3 Live-sry.py [-t target] [-p port]
```

**Example:** `python3 Live-sry.py -t https://example.com/Live-sry.py/images -p 8000`
